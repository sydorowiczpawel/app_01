    ...
    <form method="POST" action="/storeLeaveForm/{{ $object -> vehicle_number }}">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
          ...
          @else
            <input id="driver" type="text" class="form-control" @error('driver') is-invalid @enderror name="driver" value="{{ Auth::user() -> passNumber }}" required autocomplete="series" autofocus>
          @endif
