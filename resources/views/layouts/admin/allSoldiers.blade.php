...
<div class="container">
  <div>
    <a href="allSoldiers"><button class="btn btn-warning btn-sm" type="button">Soldiers</button></a>
    <a href="allTanks"><button class="btn btn-outline-warning btn-sm">Tanks</button></a>
    <a href="allDocuments"><button class="btn btn-outline-warning btn-sm">Documents</button></a>
    <a href="allLeaveForms"><button class="btn btn-outline-warning btn-sm">Leave Forms</button></a>
    <a href="addSoldier">
