...
Route::get('userDocuments/{id}', [App\Http\Controllers\DocumentController::class, 'show']);
...
Route::get('/userLeaveForms/{id}', [App\Http\Controllers\LeaveFormController::class, 'show']);
